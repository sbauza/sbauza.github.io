---
layout: single
title: "AgentReady Assessment — OpenStack Nova (vanilla)"
permalink: /agentready/report-nova_no_claude/
---
...
**Assessed**: March 23, 2026 at 5:39 PM
**AgentReady Version**: 2.29.6
**Run by**: sbauza@9ce339bc1218
...
| Metric | Value |
|--------|-------|
| **Overall Score** | **20.8/100** ⚠️ **Needs Improvement** ([Tier Definitions](https://agentready.dev/attributes.html#tier-system)) |
| **Attributes Assessed** | 20/25 |
| **Attributes Not Assessed** | 5 |
| **Assessment Duration** | 23.0s |
...
5. **Type Annotations** (Tier 1) - +10.0 points potential
...
![T3](https://img.shields.io/badge/T3-Semantic_Naming_94--100-green) **Semantic Naming** ✅ 94/100
...
- **Assessment Duration**: 23.0s
- **Assessed By**: sbauza@9ce339bc1218
- **Assessment Date**: March 23, 2026 at 5:39 PM
